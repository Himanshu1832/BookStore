...
// Getting the posts from the Databese 

export const getPost = (req, res) => {
  const q =
    "SELECT p.id, `username`, `title`, `desc`,`date`,`uid` ,`price` , `mrp`,`img` , p.branch , p.sem , p.college_name ,p.course,p.edition FROM users u JOIN posts p ON u.id = p.uid WHERE p.id = ? ";
...
// Adding the Posted Book to the Database
...
// Deleting the Posted Book from the Database
